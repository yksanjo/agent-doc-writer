/**
 * agent-doc-writer-core - Package 1: core for Technical Documentation Writer
 * Project: agent-doc-writer
 */
export class AgentDocWriterCore {
  constructor(options = {}) {
    this.name = 'agent-doc-writer-core';
...
export default AgentDocWriterCore;

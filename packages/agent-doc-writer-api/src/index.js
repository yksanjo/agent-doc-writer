/**
 * agent-doc-writer-api - Package 2: api for Technical Documentation Writer
 * Project: agent-doc-writer
 */
export class AgentDocWriterApi {
  constructor(options = {}) {
    this.name = 'agent-doc-writer-api';
...
export default AgentDocWriterApi;

/**
 * agent-doc-writer-scheduler - Service: scheduler for Technical Documentation Writer
 * Project: agent-doc-writer
 */
export class AgentDocWriterScheduler {
  constructor(options = {}) {
    this.name = 'agent-doc-writer-scheduler';
...
export default AgentDocWriterScheduler;

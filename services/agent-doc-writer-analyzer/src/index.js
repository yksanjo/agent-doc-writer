/**
 * agent-doc-writer-analyzer - Service: analyzer for Technical Documentation Writer
 * Project: agent-doc-writer
 */
export class AgentDocWriterAnalyzer {
  constructor(options = {}) {
    this.name = 'agent-doc-writer-analyzer';
...
export default AgentDocWriterAnalyzer;
